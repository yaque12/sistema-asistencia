...
/**
 * Form Request para validar la creación de razones de ausentismos
 * 
 * Este Form Request valida todos los datos necesarios para crear
 * una nueva razón de ausentismo en el sistema.
 */
class StoreRazonAusentismoRequest extends FormRequest
{
    /**
    ...
    /**
     * Reglas de validación para la creación de razones de ausentismos
     * 
    ...
    public function rules(): array
    {
        return [
            ...
            'codigo_razon_ausentismo' => [
                ...
                'string',
                'max:50',
                Rule::unique('razones_ausentismos', 'codigo_razon_ausentismo'),
            ],
            'descripcion' => [
                'nullable',
                'string',

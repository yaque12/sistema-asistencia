...
@section('title', 'Gestión de Empleados - Sistema de Asistencia')
...
@section('content')
    ...
    <div class="mb-6">
        ...
        <p class="text-gray-600 mt-2">Administra los empleados del sistema</p>
    </div>
            ...
            <div class="flex-1 w-full md:w-auto">
                <div class="relative">
                    <input 
                        type="text" 
                        id="buscar-empleado" 
                        placeholder="Buscar por nombre, apellido, departamento o código empleado..." 
    ...
    <div class="bg-white shadow-lg rounded-lg overflow-hidden">
        ...
        <!-- Paginación -->
        <div id="paginacion-empleados" class="bg-gray-50 px-6 py-4 border-t border-gray-200 flex items-center justify-between">
            <div class="text-sm text-gray-700">
                Mostrando <span id="mostrando-desde">0</span> a <span id="mostrando-hasta">0</span> de <span id="total-empleados">0</span> empleados
            </div>
    ...
    <!-- Incluir modales -->
    @include('empleados.partials.modal-crear')
    @include('empleados.partials.modal-editar')
...
@push('scripts')
    ...
    @else
        ...
        @php
            $jsPath = resource_path('js/empleados.js');
